...
sub make_instance {
    my ($class, $context) = @_;
    Carp::croak("Usage: amon2::sample::Web::View->make_instance(\$context_class)") if @_!=2;
    ...
    unless (exists $view_conf->{path}) {
        ...
        if ( -d $tmpl_path ) {
            ...
            my $share_tmpl_path = eval { File::Spec->catdir(File::ShareDir::dist_dir('amon2-sample'), 'tmpl') };
            if ($share_tmpl_path) {
    ...
    my $view = Text::Xslate->new(+{
        ...
        'module'   => [
            ...
            'amon2::sample::Web::ViewFunctions',
        ],
        'function' => {
        },
